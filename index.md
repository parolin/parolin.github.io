...
The name `show cdp neighbors` came from the Cisco command with same name, used to display information about neighboring devices discovered using [CDP Protocol](https://en.wikipedia.org/wiki/Cisco_Discovery_Protocol)
